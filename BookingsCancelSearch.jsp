...
<link href="css/BookingsCancelSearch.css" rel="stylesheet" type="text/css">
...
<body>
	...
	<div class="box col-lg-6 col-md-12 col-sm-12 col-12 d-block m-auto">
	
	<label class="field-label">Please Select Booking ID For Cancelation :</label><br>
	...
	try
	{
		...
		while(rs.next())
		{
			if(useremail.equals(rs.getString("AccountEmail")))
			{
				...
				%>
				<form action="CancelBookingsSearch" method="post">
				<input class="gui-input" type="submit" name="CancelBookingId" value="<%=getemail%>">
				</form>
				<% 		
			}
		}
