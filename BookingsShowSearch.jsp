...
<link href="css/BookingsShowSearch.css" rel="stylesheet" type="text/css">
...
<body>
	...
	<label class="field-label">Please Select Booking ID For View :</label><br>
	...
	try
	{
		...
		while(rs.next())
		{
			if(useremail.equals(rs.getString("AccountEmail")))
			{
				...
				<input class="gui-input" type="submit" name="SearchBookingId" value="<%=getemail%>">
				</form>
				<% 		
			}
		}
